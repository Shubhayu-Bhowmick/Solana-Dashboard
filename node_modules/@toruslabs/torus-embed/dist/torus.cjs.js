...
var fetch_node_details_ = __webpack_require__(8);
...
var http_helpers_ = __webpack_require__(3);
...
var obs_store_ = __webpack_require__(6);

// EXTERNAL MODULE: external "eth-rpc-errors"
var external_eth_rpc_errors_ = __webpack_require__(2);
...
const getTorusUrl = async (buildEnv, integrity) => {
  ...
  try {
    if ((buildEnv === "binance" || buildEnv === "production") && !integrity.version) {
      let response;
      if (!config.prodTorusUrl) response = await Object(http_helpers_["get"])("".concat(config.api, "/latestversion?name=@toruslabs/torus-embed&version=").concat(version), {}, {
        useAPIKey: true
      });else response = {
...
class inpage_provider_TorusInpageProvider extends openlogin_jrpc_["SafeEventEmitter"] {
  /**
  ...
  constructor(connectionStream) {
    ...
    this._state = _objectSpread({}, inpage_provider_TorusInpageProvider._defaultState); // public state
    ...
    this._publicConfigStore = new obs_store_["ObservableStore"]({
    ...
    external_pump_default()(mux.createStream("publicConfig"), Object(obs_store_["storeAsStream"])(this._publicConfigStore), // RPC requests should still work if only this stream fails
...
var external_create_hash_ = __webpack_require__(13);
...
const integrity_integrity = (options, sri) => {
...
var external_events_ = __webpack_require__(14);
...
class embed_Torus {
  ...
  _setupWeb3() {
    ...
    const metamaskStream = new openlogin_jrpc_["BasePostMessageStream"]({
      name: "embed_metamask",
    ...
    const communicationMux = Object(openlogin_jrpc_["setupMultiplex"])(communicationStream);
