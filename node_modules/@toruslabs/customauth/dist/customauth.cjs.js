...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "createHandler", function() { return /* reexport */ HandlerFactory; });
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ login; });
__webpack_require__.d(__webpack_exports__, "TORUS_NETWORK", function() { return /* reexport */ TORUS_NETWORK; });
__webpack_require__.d(__webpack_exports__, "LOGIN", function() { return /* reexport */ LOGIN; });
__webpack_require__.d(__webpack_exports__, "AGGREGATE_VERIFIER", function() { return /* reexport */ AGGREGATE_VERIFIER; });
__webpack_require__.d(__webpack_exports__, "UX_MODE", function() { return /* reexport */ UX_MODE; });
__webpack_require__.d(__webpack_exports__, "REDIRECT_PARAMS_STORAGE_METHOD", function() { return /* reexport */ REDIRECT_PARAMS_STORAGE_METHOD; });
__webpack_require__.d(__webpack_exports__, "TORUS_METHOD", function() { return /* reexport */ TORUS_METHOD; });
__webpack_require__.d(__webpack_exports__, "CONTRACT_MAP", function() { return /* reexport */ CONTRACT_MAP; });
__webpack_require__.d(__webpack_exports__, "NETWORK_MAP", function() { return /* reexport */ NETWORK_MAP; });
__webpack_require__.d(__webpack_exports__, "SIGNER_MAP", function() { return /* reexport */ SIGNER_MAP; });
__webpack_require__.d(__webpack_exports__, "eventToPromise", function() { return /* reexport */ eventToPromise; });
__webpack_require__.d(__webpack_exports__, "loginToConnectionMap", function() { return /* reexport */ loginToConnectionMap; });
__webpack_require__.d(__webpack_exports__, "padUrlString", function() { return /* reexport */ padUrlString; });
__webpack_require__.d(__webpack_exports__, "randomId", function() { return /* reexport */ randomId; });
__webpack_require__.d(__webpack_exports__, "broadcastChannelOptions", function() { return /* reexport */ broadcastChannelOptions; });
__webpack_require__.d(__webpack_exports__, "getVerifierId", function() { return /* reexport */ getVerifierId; });
__webpack_require__.d(__webpack_exports__, "handleRedirectParameters", function() { return /* reexport */ handleRedirectParameters; });
__webpack_require__.d(__webpack_exports__, "storageAvailable", function() { return /* reexport */ storageAvailable; });
__webpack_require__.d(__webpack_exports__, "storeLoginDetails", function() { return /* reexport */ storeLoginDetails; });
__webpack_require__.d(__webpack_exports__, "retrieveLoginDetails", function() { return /* reexport */ retrieveLoginDetails; });
__webpack_require__.d(__webpack_exports__, "clearLoginDetailsStorage", function() { return /* reexport */ clearLoginDetailsStorage; });
__webpack_require__.d(__webpack_exports__, "clearOrphanedLoginDetails", function() { return /* reexport */ clearOrphanedLoginDetails; });
__webpack_require__.d(__webpack_exports__, "getPopupFeatures", function() { return /* reexport */ getPopupFeatures; });
__webpack_require__.d(__webpack_exports__, "isFirefox", function() { return /* reexport */ isFirefox; });
__webpack_require__.d(__webpack_exports__, "constructURL", function() { return /* reexport */ constructURL; });

// EXTERNAL MODULE: external "@toruslabs/fetch-node-details"
var fetch_node_details_ = __webpack_require__(6);
...
const NETWORK_MAP = {
  [TORUS_NETWORK.MAINNET]: fetch_node_details_["ETHEREUM_NETWORK"].MAINNET,
  [TORUS_NETWORK.TESTNET]: fetch_node_details_["ETHEREUM_NETWORK"].ROPSTEN,
  [TORUS_NETWORK.CYAN]: fetch_node_details_["ETHEREUM_NETWORK"].POLYGON
};
const SIGNER_MAP = {
...
var external_lodash_merge_ = __webpack_require__(2);
...
var objectWithoutProperties_ = __webpack_require__(3);
...
var external_broadcast_channel_ = __webpack_require__(7);

// EXTERNAL MODULE: external "loglevel"
var external_loglevel_ = __webpack_require__(4);
...
function retrieveLoginDetails(storageMethod, scope) {
  if (storageStatus[storageMethod]) {
    const loginDetails = window[storageMethod].getItem("torus_login_".concat(scope));
...
class PopupHandler_PopupHandler extends external_events_["EventEmitter"] {
  constructor(_ref) {
    let {
      url,
      target,
...
class AbstractLoginHandler_AbstractLoginHandler {
    ...
    if (this.uxMode === UX_MODE.REDIRECT) {
      ...
      return new Promise((resolve, reject) => {
        ...
        if (!this.redirectToOpener) {
          bc = new external_broadcast_channel_["BroadcastChannel"]("redirect_channel_".concat(this.nonce), broadcastChannelOptions);
...
class DiscordHandler_DiscordHandler extends handlers_AbstractLoginHandler {
  constructor(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState) {
  ...
  async getUserInfo(params) {
    ...
    const userInfo = await Object(http_helpers_["get"])("https://discord.com/api/users/@me", {
      headers: {
    ...
    const profileImage = avatar === null ? "https://cdn.discord.com/embed/avatars/".concat(Number(discriminator) % 5, ".png") : "https://cdn.discord.com/avatars/".concat(id, "/").concat(avatar, ".png?size=2048");
    return {
      profileImage,
...
class FacebookHandler_FacebookHandler extends handlers_AbstractLoginHandler {
  constructor(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState) {
    super(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState);
    this.clientId = clientId;
    this.verifier = verifier;
  ...
  async getUserInfo(params) {
    ...
    const userInfo = await Object(http_helpers_["get"])("https://graph.facebook.com/me?fields=name,email,picture.type(large)", {
      headers: {
        Authorization: "Bearer ".concat(accessToken)
      }
    });
...
class GoogleHandler_GoogleHandler extends handlers_AbstractLoginHandler {
  constructor(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState) {
    super(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState);
    this.clientId = clientId;
    this.verifier = verifier;
  ...
  async getUserInfo(params) {
    ...
    const userInfo = await Object(http_helpers_["get"])("https://www.googleapis.com/userinfo/v2/me", {
      headers: {
        Authorization: "Bearer ".concat(accessToken)
      }
    });
...
class JwtHandler_JwtHandler extends handlers_AbstractLoginHandler {
  constructor(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState) {
    super(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState);
    this.clientId = clientId;
    this.verifier = verifier;
  ...
  async getUserInfo(params) {
    ...
    if (accessToken) {
      try {
        ...
        const userInfo = await Object(http_helpers_["get"])("".concat(padUrlString(domainUrl)).concat(user_info_route), {
          headers: {
            Authorization: "Bearer ".concat(accessToken)
          }
        });
        ...
        // ignore
        external_loglevel_default.a.warn(error, "Unable to get userinfo from endpoint");
      }
    }
...
class MockLoginHandler_MockLoginHandler extends handlers_AbstractLoginHandler {
  constructor(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState) {
    super(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState);
    this.clientId = clientId;
    this.verifier = verifier;
...
class PasswordlessHandler_JwtHandler extends handlers_AbstractLoginHandler {
  ...
  async getUserInfo(params) {
    ...
    try {
      const domainUrl = new URL(domain);
      const userInfo = await Object(http_helpers_["get"])("".concat(padUrlString(domainUrl), "userinfo"), {
        headers: {
          Authorization: "Bearer ".concat(accessToken)
        }
      });
  ...
  handleLoginWindow() {
    return new Promise((resolve, reject) => {
      ...
      const bc = new external_broadcast_channel_["BroadcastChannel"]("redirect_channel_".concat(this.nonce), broadcastChannelOptions);
      bc.addEventListener("message", async ev => {
        handleData(ev);
        bc.close();
      });
      ...
      try {
        ...
        Object(http_helpers_["post"])(this.finalURL.href, JSON.parse(JSON.stringify(finalJwtParams))).then(response => {
...
class RedditHandler_RedditHandler extends handlers_AbstractLoginHandler {
  constructor(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState) {
    super(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState);
    this.clientId = clientId;
    this.verifier = verifier;
  ...
  setFinalUrl() {
    const finalUrl = new URL("https://www.reddit.com/api/v1/authorize".concat(window.innerWidth < 600 ? ".compact" : ""));
    const clonedParams = JSON.parse(JSON.stringify(this.jwtParams || {}));
    const finalJwtParams = external_lodash_merge_default()({
      state: this.state,
      response_type: this.RESPONSE_TYPE,
  ...
  async getUserInfo(params) {
    ...
    const userInfo = await Object(http_helpers_["get"])("https://oauth.reddit.com/api/v1/me", {
      headers: {
        Authorization: "Bearer ".concat(accessToken)
      }
    });
...
class TwitchHandler_TwitchHandler extends handlers_AbstractLoginHandler {
  constructor(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState) {
    super(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState);
    this.clientId = clientId;
    this.verifier = verifier;
  ...
  async getUserInfo(params) {
    ...
    const userInfo = await Object(http_helpers_["get"])("https://api.twitch.tv/helix/users", {
      headers: {
        Authorization: "Bearer ".concat(accessToken),
...
class WebAuthnHandler_WebAuthnHandler extends handlers_AbstractLoginHandler {
    ...
    if (extraParamsPassed === "true") {
      ...
      try {
        ...
        ({
          ...
          rpOrigin,
          credId
        } = await Object(http_helpers_["get"])("".concat(WEBAUTHN_LOOKUP_SERVER, "/signature/fetch/").concat(idToken)));
      }
    } else {
...
const createHandler = _ref => {
  ...
  switch (typeOfLogin) {
    ...
    case LOGIN.FACEBOOK:
      return new FacebookHandler_FacebookHandler(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState);
    ...
    case LOGIN.JWT:
      ...
      if (id_token || access_token) {
        return new MockLoginHandler_MockLoginHandler(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState);
      }
    ...
    case LOGIN.WEBAUTHN:
      return new WebAuthnHandler_WebAuthnHandler(clientId, verifier, redirect_uri, typeOfLogin, uxMode, redirectToOpener, jwtParams, customState, registerOnly);
...
class login_CustomAuth {
  constructor(_ref) {
    ...
    const torus = new torus_js_default.a({
      enableOneKey,
  ...
  async init() {
    ...
    if (!skipSw) {
      const fetchSwResponse = await fetch("".concat(this.config.baseUrl, "sw.js"), {
        cache: "reload"
      });
  ...
  async triggerLogin(args) {
    ...
    if (hash && queryParameters) {
      ...
      storeLoginDetails({
        ...
        args
      }, this.config.redirectParamsStorageMethod, loginHandler.nonce);
    ...
    if (registerOnly) {
      ...
      const torusPubKey = await this.torus.getPublicAddress(torusNodeEndpoints, torusNodePub, {
        verifier,
        verifierId: userInfo.verifierId
      }, true);
      const res = {
  ...
  async triggerAggregateLogin(args) {
    ...
    const aggregateIdToken = Object(external_web3_utils_["keccak256"])(aggregateIdTokenSeeds.join(String.fromCharCode(29))).slice(2);
  ...
  async triggerHybridAggregateLogin(args) {
    ...
    } = args; // This method shall break if any of the promises fail. This behaviour is intended
  ...
  async getTorusKey(verifier, verifierId, verifierParams, idToken, additionalParams) {
    ...
    const address = await this.torus.getPublicAddress(torusNodeEndpoints, torusNodePub, {
      verifier,
      verifierId
    }, true);
  ...
  async getAggregateTorusKey(verifier, verifierId, // unique identifier for user e.g. sub on jwt
  ...
  async getRedirectResult() {
    ...
    const _retrieveLoginDetails = retrieveLoginDetails(this.config.redirectParamsStorageMethod, instanceId),
          {
      args,
      method
    ...
    try {
      ...
      return login_objectSpread({
        error: "Could not get result from torus nodes \n ".concat((err === null || err === void 0 ? void 0 : err.message) || ""),
        state: instanceParameters || {},
        method,
        result: {},
        hashParameters,
        ...
        if (redirectHtml.relList && redirectHtml.relList.supports) {
          if (redirectHtml.relList.supports("prefetch")) {
            ...
            redirectHtml.onerror = () => {
              reject(new Error("Please serve redirect.html present in serviceworker folder of this package on ".concat(this.config.redirect_uri)));
            };
