...
module.exports = require("@toruslabs/solana-embed");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "SolanaWalletAdapter", function() { return /* reexport */ solanaWalletAdapter_SolanaWalletAdapter; });

// EXTERNAL MODULE: external "@babel/runtime/helpers/defineProperty"
var defineProperty_ = __webpack_require__(1);
var defineProperty_default = /*#__PURE__*/__webpack_require__.n(defineProperty_);

// EXTERNAL MODULE: external "@toruslabs/solana-embed"
var solana_embed_ = __webpack_require__(3);
var solana_embed_default = /*#__PURE__*/__webpack_require__.n(solana_embed_);

// EXTERNAL MODULE: external "@web3auth/base"
var base_ = __webpack_require__(0);

// EXTERNAL MODULE: external "@web3auth/solana-provider"
var solana_provider_ = __webpack_require__(4);
...
class solanaWalletAdapter_SolanaWalletAdapter extends base_["BaseAdapter"] {
  constructor() {
    let params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    super();

    defineProperty_default()(this, "name", base_["WALLET_ADAPTERS"].TORUS_SOLANA);
  ...
  get provider() {
    if (this.status === base_["ADAPTER_STATUS"].CONNECTED && this.solanaProvider) {
  ...
  async init(options) {
    ...
    this.torusInstance = new solana_embed_default.a(this.torusWalletOptions);
    external_loglevel_default.a.debug("solana wallet network", network);
    await this.torusInstance.init(_objectSpread(_objectSpread({
      showTorusButton: false
    }, this.initParams), {}, {
      network
    }));
    external_loglevel_default.a.debug("solana chainConfig", this.chainConfig);
    this.solanaProvider = new solana_provider_["TorusInjectedProvider"]({
      config: {
        chainConfig: this.chainConfig
      }
    });
    this.status = base_["ADAPTER_STATUS"].READY;
    this.emit(base_["ADAPTER_EVENTS"].READY, base_["WALLET_ADAPTERS"].TORUS_SOLANA);
    ...
    try {
      ...
      external_loglevel_default.a.error("Failed to connect with cached torus solana provider", error);
  ...
  async connect() {
    ...
    if (!this.solanaProvider) throw base_["WalletInitializationError"].notReady("Torus wallet is not initialized");
    this.status = base_["ADAPTER_STATUS"].CONNECTING;
    this.emit(base_["ADAPTER_EVENTS"].CONNECTING, {
      adapter: base_["WALLET_ADAPTERS"].TORUS_SOLANA
    });
    ...
    try {
      ...
      this.emit(base_["ADAPTER_EVENTS"].ERRORED, error);
      throw base_["WalletLoginError"].connectionError("Failed to login with torus solana wallet");
    }
  }
