...
export declare const DEFAULT_INFURA_ID = "776218ac4734478c90191dde8cae483c";
...
export declare const getChainConfig: (chainNamespace: ChainNamespaceType, chainId?: number | string) => CustomChainConfig | undefined;
