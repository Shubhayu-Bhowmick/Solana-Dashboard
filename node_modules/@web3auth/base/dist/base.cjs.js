...
__webpack_require__.d(__webpack_exports__, "ADAPTER_EVENTS", function() { return /* reexport */ ADAPTER_EVENTS; });
...
__webpack_require__.d(__webpack_exports__, "ADAPTER_NAMESPACES", function() { return /* reexport */ ADAPTER_NAMESPACES; });
__webpack_require__.d(__webpack_exports__, "Web3AuthError", function() { return /* reexport */ errors_Web3AuthError; });
__webpack_require__.d(__webpack_exports__, "WalletInitializationError", function() { return /* reexport */ WalletInitializationError; });
__webpack_require__.d(__webpack_exports__, "WalletLoginError", function() { return /* reexport */ WalletLoginError; });
...
__webpack_require__.d(__webpack_exports__, "isHexStrict", function() { return /* reexport */ isHexStrict; });
__webpack_require__.d(__webpack_exports__, "MULTI_CHAIN_ADAPTERS", function() { return /* reexport */ MULTI_CHAIN_ADAPTERS; });
__webpack_require__.d(__webpack_exports__, "SOLANA_ADAPTERS", function() { return /* reexport */ SOLANA_ADAPTERS; });
__webpack_require__.d(__webpack_exports__, "EVM_ADAPTERS", function() { return /* reexport */ EVM_ADAPTERS; });
__webpack_require__.d(__webpack_exports__, "WALLET_ADAPTERS", function() { return /* reexport */ WALLET_ADAPTERS; });
...
var external_ts_custom_error_ = __webpack_require__(2);

// CONCATENATED MODULE: ./src/errors/index.ts

 // @flow

class errors_Web3AuthError extends external_ts_custom_error_["CustomError"] {
...
class WalletInitializationError extends errors_Web3AuthError {
  constructor(code, message) {
    // takes care of stack and proto
...
class WalletLoginError extends errors_Web3AuthError {
  constructor(code, message) {
    // takes care of stack and proto
    super(code, message); // Set name explicitly as minification can mangle class names
...
function wallet_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function wallet_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? wallet_ownKeys(Object(source), !0).forEach(function (key) { defineProperty_default()(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : wallet_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
const SOLANA_ADAPTERS = wallet_objectSpread({
  TORUS_SOLANA: "torus-solana",
  PHANTOM: "phantom"
}, MULTI_CHAIN_ADAPTERS);
const EVM_ADAPTERS = wallet_objectSpread({
  TORUS_EVM: "torus-evm",
  METAMASK: "metamask"
}, MULTI_CHAIN_ADAPTERS);
const WALLET_ADAPTERS = wallet_objectSpread(wallet_objectSpread({}, EVM_ADAPTERS), SOLANA_ADAPTERS);
...
class IAdapter_BaseAdapter extends openlogin_jrpc_["SafeEventEmitter"] {
  ...
  get chainConfigProxy() {
    return this.chainConfig ? IAdapter_objectSpread({}, this.chainConfig) : undefined;
  }
